...
try {
  if (fs.existsSync(DB_FILE)) {
    ...
    console.log("✅ Registros carregados do JSON:", registros.length);
  } else {
    console.log("⚠️ Arquivo registros.json não encontrado. Criando novo...");
    salvarRegistros();
  }
} catch (erro) {
...
function salvarRegistros() {
  try {
    ...
    console.error("❌ Erro ao salvar registros:", erro.message);
  }
}
